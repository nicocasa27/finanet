    ...
    <section className="relative w-full pt-32 pb-20 px-4 md:px-6 flex flex-col items-center text-center bg-gradient-to-b from-blue-100/50 via-background to-background">
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-8 md:gap-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <Button asChild size="lg" className="bg-foreground text-background hover:bg-foreground/90 rounded-none px-8 h-14 text-base font-mono border-2 border-foreground">
            <Link to="/auth">
              Solicitar demo
            </Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="border-2 border-foreground text-foreground hover:bg-foreground hover:text-background rounded-none px-8 h-14 text-base font-mono">
            <Link to="/features">
              Explorar plataforma →
            </Link>
          </Button>
