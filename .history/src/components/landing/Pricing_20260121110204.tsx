        ...
        <div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-3">
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative p-6 md:p-8 rounded-2xl transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
                plan.popular
                  ? "bg-foreground text-background shadow-2xl md:scale-[1.02] ring-4 ring-accent"
